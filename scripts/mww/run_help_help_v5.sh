...
# 对抗性负样本 mmap
ADV_MMAP="${DATA_DIR}/negative_datasets/en_helphelp_adv_v5/en_helphelp_adv_v5/training/en_helphelp_adv_v5_mmap"
if [ -d "$ADV_MMAP" ]; then
    ...
    python3 ${SCRIPT_DIR}/generate_adversarial_features.py \
        ...
        --output-dir ${DATA_DIR}/negative_datasets/en_helphelp_adv_v5/en_helphelp_adv_v5 \
        --data-dir ${DATA_DIR}
fi
...
window_step_ms: 10
train_dir: trained_models/help_help_v5
features:
...
- features_dir: negative_datasets/no_speech/no_speech
  ...
  truncation_strategy: random
  type: mmap
- features_dir: negative_datasets/en_helphelp_adv_v5/en_helphelp_adv_v5
