...
def main():
    ...
    parser.add_argument("--train-dir", default="trained_models/help_help_v1")
    ...
    config = {
        ...
        "features": [
            ...
            # 对抗性负样本（help me, health, hello 等）
            {
                "features_dir": "negative_datasets/en_adversarial/en_adversarial",
    ...
    print(f"[done] help_help 训练配置: {output}")
